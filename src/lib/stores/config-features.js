export const config = {
	mapTitle: 'fairness-perception-green-transition-europe', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'map-fairness-perception-green-transition.vercel.app', // The url provided when deploying the map on Vercel
